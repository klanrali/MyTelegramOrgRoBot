...
class Config(object):
    ...
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/NQ0BOT")
    APP_DESCRIPTION = os.environ.get("APP_DESCRIPTION", "created using https://telegram.dog/NQ0BOT")
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "⌔︙🕷🇮🇶  @IQTHON")
